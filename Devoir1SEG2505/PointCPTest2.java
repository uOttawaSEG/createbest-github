...
public class PointCPTest2
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("\nYou entered(stored as Polar):\n" + point);
	PointCP2 pointCPConverted=new PointCP2(0.0,0.0);
	pointCPConverted= point.convertStorageToCartesian();
    System.out.println("\nAfter being converted to Cartesian:\n" + pointCPConverted);
  }
