...
public class PointCPTest3
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("\nYou entered(stored as Cartesian):\n" + point);
	PointCP3 pointCPConverted=new PointCP3(0.0,0.0);
	pointCPConverted= point.convertStorageToPolar();
    System.out.println("\nAfter being converted to Polar:\n" + pointCPConverted);
  }
